...
class NewDataset(Dataset):
    ...
    def remove_test_data(self, dynamic_edges):
        df = pd.read_csv("results/NEW_DATASET--"+self.name+"/GatedGCN/POS_PRED/pred_score_with_0_pos.csv", header=None)
    ...
    def get_test_edge(self, ROOT_PATH, name):
        ...
        df = pd.concat([dynamic_edges, train_func_df, test_func_df])
